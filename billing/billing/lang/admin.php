...
(
    ...
    'register_tab_desc' => "Настройки формы регистрации и подтверждения номера WhatsApp",
    'register_group' => "Группа новых пользователей:",
    'register_group_desc' => "Все новые пользователи будут автоматически добавляться в выбранную группу DLE",
    'register_login_field' => "Использовать в качестве логина:",
    'register_login_field_desc' => "Определяет, что будет использоваться для авторизации — номер телефона или введённое имя",
    'register_login_field_phone' => "Номер телефона",
    'register_login_field_name' => "Имя пользователя",
    'register_login_url' => "Ссылка на страницу входа:",
    'register_login_url_desc' => "URL страницы авторизации, который будет показан пользователю после регистрации",
    'register_success_redirect' => "Редирект после регистрации:",
    'register_success_redirect_desc' => "Необязательный URL для автоматического перенаправления после успешной регистрации",

    'whatsapp_settings' => "WhatsApp подтверждение",
    'whatsapp_enabled' => "Включить подтверждение WhatsApp:",
    'whatsapp_enabled_desc' => "Запрашивать номер телефона и подтверждать регистрацию кодом из WhatsApp",
    'whatsapp_phone_id' => "Phone number ID:",
    'whatsapp_phone_id_desc' => "Идентификатор номера в WhatsApp Cloud API",
    'whatsapp_token' => "Access token:",
    'whatsapp_token_desc' => "Постоянный токен доступа для отправки сообщений через WhatsApp Cloud API",
    'whatsapp_template' => "Шаблон сообщения:",
    'whatsapp_template_desc' => "Название утвержденного шаблона WhatsApp с плейсхолдером под код",
    'whatsapp_language' => "Язык шаблона:",
    'whatsapp_language_desc' => "Код языка шаблона (например, ru)",
    'whatsapp_require_code' => "Требовать код:",
    'whatsapp_require_code_desc' => "Если выключить, регистрация будет доступна даже при недоступности WhatsApp",
    'whatsapp_code_ttl' => "Срок действия кода (мин):",
    'whatsapp_code_ttl_desc' => "Сколько минут действителен одноразовый код",
    'whatsapp_resend_timeout' => "Повторная отправка (сек):",
    'whatsapp_resend_timeout_desc' => "Интервал между повторными отправками кода",
    'whatsapp_daily_limit' => "Отправок в сутки:",
    'whatsapp_daily_limit_desc' => "Максимальное количество кодов в сутки на один номер",
    'whatsapp_attempt_limit' => "Попыток ввода:",
    'whatsapp_attempt_limit_desc' => "Количество неверных вводов кода до блокировки",
    'whatsapp_block_minutes' => "Время блокировки (мин):",
    'whatsapp_block_minutes_desc' => "На сколько минут блокировать номер после превышения лимитов",
    'whatsapp_stub_mode' => "Тестовый режим:",
    'whatsapp_stub_mode_desc' => "Коды не отправляются в WhatsApp, а записываются только в лог модуля",
    'whatsapp_debug_phone' => "Тестовый номер:",
    'whatsapp_debug_phone_desc' => "Для указанного номера коды всегда попадают в лог (удобно для отладки)",
